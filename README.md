...
- forked from (https://github.com/Umbrella001/wx-yunyinyue)
- 后端api https://github.com/Binaryify/NeteaseCloudMusicApi 通过`docker run -d -p 8007:3000 binaryify/netease_cloud_music_api`部署，api url https://musicapi.rscl.cc
...
> > ✪ 播放音乐时，在tabBar页增加显示音乐播放页导航图标，点击可跳转到当前播放歌曲界面
